...
function setParams(){
    switch(device){
        ...
        case "md":
            console.log("small");
            let height = screen.height - (document.getElementsByClassName("navbar")[0].offsetHeight + document.getElementById("section1").offsetHeight);
            document.getElementsByClassName("footer")[0].style.minHeight = height+"px";
